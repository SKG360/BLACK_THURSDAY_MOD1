...
class ItemRepositoryTest < Minitest::Test
  ...
  def test_if_it_finds_item_by_id
    ...
    assert_equal 'Puppy blankie', ir.find_by_id(263538760).name
  ...
  def test_if_it_can_find_all_items_by_price
    ...
    found_by_price = ir.find_all_by_price(price_1)
    assert_equal 79, found_by_price.count

    price_2 = BigDecimal.new(20000)
    assert_equal 0, ir.find_all_by_price(price_2).length
  end
